...
public class MainActivity extends AppCompatActivity { EditText edtmalop, edttenlop, edtsiso;
...
// Tạo và mở cơ sở dữ liệu Sqlite
        mydatabase = openOrCreateDatabase ("glsinhvien.db", MODE_PRIVATE, null);
...
catch (Exception e)
{
        ...
        btninsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String msg = "";
                if (mydatabase.insert("thllop", null, myvalue) == - 1) {
...
btndelete.setOnClickListener(new View.OnClickListener() {
    ...
    Toast.makeText(MainActivity.this, msg,
        ...
        btnquery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mylist.clear();
                Cursor c = (Cursor) mydatabase.query("tbllop", null, null, null, null, null, null);
                c.moveToNext();
                String data = "";
